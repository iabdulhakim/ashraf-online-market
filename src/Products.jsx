  ...
  return (
    <div className="container">
        <div className="justify-between items-center hidden md:flex py-3">
            <a className="text-2xl font-bold text-white" href="">Online Market</a>
            <div className="flex items-center gap-5">
                <a href="#" className="text-lg text-white font-medium hover:underline transition-all">About</a>
                <a href="#" className="text-lg text-white font-medium hover:underline transition-all">Contact</a>
            </div>
       </div>
