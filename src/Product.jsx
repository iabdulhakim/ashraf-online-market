  ...
  return (
    <div className="container">
      <div className="md:flex max-w-[900px] p-4 space-x-4  cursor-pointer max-h-[500px] bg-neutral rounded-box gap-10">
        ...
        <div className="">
            <h1 className="text-3xl md:text-5xl mb-4 font-bold text-white mt-16">Name:  {post && post.title}</h1>
            ...
            <p className="text-lg md:text-xl text-white mt-2 mb-10 pb-10">
                Rating: {post && post.rating} / 5.00
            </p>
        </div>
      </div>
    </div>
